...
export const getTournamentQuerySchema = z
  .object({
    ...
    /** Filter by participation or tournaments created by the requester. Requires authentication; silently ignored for guests. */
    participation: z.enum(["joined", "notJoined", "organisedByMe"]).optional(),
    timezone: z
      .string()
      .trim()
      .min(1)
